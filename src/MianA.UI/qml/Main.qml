...
ApplicationWindow {
    ...
    Component {
        id: compactComponent
        Views.CompactWindow { controller: root.appController; mainWindow: root }
    }
    Component {
        id: floatingComponent
        Views.FloatingWindow { controller: root.appController; mainWindow: root }
    }
    ...
    Component {
        ...
        Views.SettingsWindow { controller: root.appController; mainWindow: root }
    }
    Loader {
        id: settingsLoader
        active: false
