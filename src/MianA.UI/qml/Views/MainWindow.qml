...
ColumnLayout {
    ...
    Item {
        ...
        RowLayout {
            ...
            Components.AppButton { controller: view.controller; text: "↻"; font.family: "Segoe UI Symbol"; font.pixelSize: 12; font.bold: true; Layout.alignment: Qt.AlignVCenter; onClicked: view.controller.manualRefresh() }
            Components.AppButton { controller: view.controller; text: "＋ 添加"; font.pixelSize: 10; font.bold: true; Layout.alignment: Qt.AlignVCenter; onClicked: view.addRequested() }
        }
    }
    ListView {
        id: list
